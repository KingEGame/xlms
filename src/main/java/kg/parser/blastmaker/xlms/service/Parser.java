...
import kg.parser.blastmaker.xlms.specification.SearchCriteria;
import kg.parser.blastmaker.xlms.specification.Specificator;
...
public class Parser {
    ...
    @Autowired
    TruckTripsRespository truckTrips;
